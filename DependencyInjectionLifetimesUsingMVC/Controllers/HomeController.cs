...
namespace DependencyInjectionLifetimesUsingMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            // for every refresh ...
            // Transient : methods of 2 objects will generate new guids everytime seperately. means 1st object is not shared with 2nd request. it creates new object
            // Scoped : methods of 2 objects will have same guid. guid changes only when page refreshed. but same for both objects. means 1st object is shared for 2nd request.
            // Singleton : methods of 2 objects will have same guid. same guids even if page refreshed. means one single object is shared for entire application lifetime
